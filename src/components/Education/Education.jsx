...
const Education = () => {
  ...
  return (
    ...
    className='absolute left-9 top-0 w-[4px] h-full bg-dark origin-top'/>
            ...
            info="Los cursos relevantes incluyeron estructuras de datos y algoritmos, ingeniería de sistemas informáticos y artificial
            Inteligencia"
            />
            ...
            info="Completó un proyecto de maestría sobre aprendizaje profundo, desarrollando una nueva arquitectura de red neuronal para natural
